              ...
              <View style={styles.contain}>
                ...
                <View style={{flexDirection:'row', justifyContent:'center', flex:1,marginTop: 20,position:'relative'}}>
                  ...
                  <View style={{flexDirection:'column', alignItems:'center', flex:1, marginTop: 20, position:'relative'}}>
                        ...
                        <TouchableOpacity style={{position:'absolute', bottom:48, right:81}} onPress={() => router.push("../editprofile")} >
                ...
                <View style={{flex: 1, flexDirection: 'column', marginTop: 20,gap:20}}>
                    < SettingsIteam icon={icons.calendar} title="My Booking" textStyle={undefined} onPress={() => router.push("../booking")} />
                    < SettingsIteam icon={icons.wallet} title="My Products" textStyle={undefined}  onPress={() => router.push("../myproduct")}/>
                    < SettingsIteam icon={icons.wallet} title="My Articles" textStyle={undefined}  onPress={() => router.push("../myarticle")}/>

                    < SettingsIteam icon={icons.wallet} title="Payment" textStyle={undefined}  onPress={() => router.push("../payment")} />
                ...
                < SettingsIteam icon={icons.person} title="Profile" textStyle={undefined}  onPress={() => router.push("../editprofile")} />
                < SettingsIteam icon={icons.bell} title="Notification" textStyle={undefined}  onPress={() => router.push("../notification")} />
                < SettingsIteam icon={icons.shield} title="Security" textStyle={undefined}  onPress={() => router.push("../security")} />
                < SettingsIteam icon={icons.language} title="Langauge" textStyle={undefined}  onPress={() => router.push("../langauge")} />
                < SettingsIteam icon={icons.info} title="Help Center" textStyle={undefined}  onPress={() => router.push("../helpcenter")} />
                < SettingsIteam icon={icons.people} title="Invite Friends" textStyle={undefined}  onPress={() => router.push("../invitefriend")} />
